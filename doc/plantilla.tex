...
\author{Gabriel Aumala, Wilson Enriquez, Kevin Zambrano}
...
\begin{figure}[h]
  \centering
    \includegraphics{Imagenes/logosci}
...
\begin{figure}[!h]
  \centering
    \includegraphics[scale=0.5]{Imagenes/Captura2}
...
\begin{figure}[!h]
  \centering
    \includegraphics[scale=0.5]{Imagenes/Captura3}
...
\begin{figure}[!h]
  \centering
    \includegraphics[scale=0.5]{Imagenes/Captura4}
...
\begin{figure}[!h]
  \centering
    \includegraphics[scale=0.5]{Imagenes/Captura5}
...
\begin{figure}[!h]
  \centering
    \includegraphics[scale=0.5]{Imagenes/Captura6}
...
Ahora que hemos terminado de sumar números con Scilab, supongamos que tenemos un par de matrices. Multiplicar matrices es un proceso largo y tedioso. Afortunadamente Scilab puede resolver este problema rápidamente. En Scilab las mátrices se pueden declarar rápidamente utilizando los correctos signos de puntuación. En el Listing 3 se observa cómo tras declarar las dos  matrices se las puede multiplicar utilizando el mismo número de líneas de código que en el programa anterior.
...
\bibitem{scilaborg1} \textsc{About Scilab} \textit{http://www.scilab.org/scilab/history}, Scilab Enterprises,
S.A.S, 2013.
\bibitem{scilaborg2} \textsc{History }  \textit{http://www.scilab.org/scilab/about}, Scilab Enterprises,
S.A.S, 2013.
\bibitem{scilab3} \textsc{Scicos Hardware In The Loop }  \textit{ http://www-scicos.inria.fr/scicoshil.htm}
\bibitem{scilab4} \textsc{SCILAB Consortium launched}, Gomez, Claude, julio de 2003.
\bibitem{scilab5} \textsc{Modeling and Simulation in Scilab/Scicos }, Stephen L. Campbell, Jean-Philippe Chancellier and Ramine Nikoukhah
